...
class Running(Training):
    ...
    def get_spent_calories(self) -> float:
        """Количество затрачеваемых калорий при беге."""
...
class SportsWalking(Training):
    ...
    def get_spent_calories(self) -> float:
        """Количество затрачеваемых калорий при спортивной ходьбе."""
        return ((self.CALORIES_WEIGHT_MULTIPLIER * self.weight
                 + ((self.get_mean_speed() * self.KM_IN_SEC) ** 2
...
class Swimming(Training):
    ...
    def get_spent_calories(self) -> float:
        """Количество затрачеваемых калорий при плавании."""
        return ((self.get_mean_speed() + self.COEF1)
                * self.COEF2 * self.weight * self.duration)
